...
'-h[Print help]' \
'--help[Print help]' \
":: :_warp-cli__environment_commands" \
"*::: :->environment" \
&& ret=0
    ...
    (environment)
        words=($line[1] "${words[@]}")
        (( CURRENT += 1 ))
        curcontext="${curcontext%:*:*}:warp-cli-environment-command-$line[1]:"
        case $line[1] in
            (set)
_arguments "${_arguments_options[@]}" : \
'--no-paginate[Disable automatic pagination]' \
'-h[Print help (see more with '\''--help'\'')]' \
'--help[Print help (see more with '\''--help'\'')]' \
':environment:((Normal\:"Use the normal environment for API and Tunnel communications"
FedRAMP-High\:"Use the FedRAMP High environment for API and Tunnel communications"))' \
&& ret=0
;;
(reset)
_arguments "${_arguments_options[@]}" : \
...
(help)
_arguments "${_arguments_options[@]}" : \
":: :_warp-cli__environment__help_commands" \
"*::: :->help" \
&& ret=0
    ...
    (help)
        words=($line[1] "${words[@]}")
        (( CURRENT += 1 ))
        curcontext="${curcontext%:*:*}:warp-cli-environment-help-command-$line[1]:"
        case $line[1] in
            (set)
_arguments "${_arguments_options[@]}" : \
&& ret=0
...
(environment)
_arguments "${_arguments_options[@]}" : \
":: :_warp-cli__help__environment_commands" \
"*::: :->environment" \
&& ret=0
    ...
    (environment)
        words=($line[1] "${words[@]}")
        (( CURRENT += 1 ))
        curcontext="${curcontext%:*:*}:warp-cli-help-environment-command-$line[1]:"
        case $line[1] in
            (set)
_arguments "${_arguments_options[@]}" : \
&& ret=0
...
'upload-stats:A hidden debug command to manually trigger an uploading of the stats' \
'help:Print this message or the help of the given subcommand(s)' \
    )
...
(( $+functions[_warp-cli__debug__help__upload-stats_commands] )) ||
_warp-cli__debug__help__upload-stats_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli debug help upload-stats commands' commands "$@"
}
...
(( $+functions[_warp-cli__debug__upload-stats_commands] )) ||
_warp-cli__debug__upload-stats_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli debug upload-stats commands' commands "$@"
}
...
(( $+functions[_warp-cli__environment_commands] )) ||
_warp-cli__environment_commands() {
    local commands; commands=(
...
'help:Print this message or the help of the given subcommand(s)' \
    ...
    _describe -t commands 'warp-cli environment commands' commands "$@"
}
(( $+functions[_warp-cli__environment__help_commands] )) ||
_warp-cli__environment__help_commands() {
    local commands; commands=(
'set:Set the client'\''s compliance environment' \
'reset:Reset the client'\''s compliance environment override' \
'help:Print this message or the help of the given subcommand(s)' \
    ...
    _describe -t commands 'warp-cli environment help commands' commands "$@"
}
(( $+functions[_warp-cli__environment__help__help_commands] )) ||
_warp-cli__environment__help__help_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli environment help help commands' commands "$@"
}
(( $+functions[_warp-cli__environment__help__reset_commands] )) ||
_warp-cli__environment__help__reset_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli environment help reset commands' commands "$@"
}
(( $+functions[_warp-cli__environment__help__set_commands] )) ||
_warp-cli__environment__help__set_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli environment help set commands' commands "$@"
}
(( $+functions[_warp-cli__environment__reset_commands] )) ||
_warp-cli__environment__reset_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli environment reset commands' commands "$@"
}
(( $+functions[_warp-cli__environment__set_commands] )) ||
_warp-cli__environment__set_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli environment set commands' commands "$@"
}
...
(( $+functions[_warp-cli__help__debug__upload-stats_commands] )) ||
_warp-cli__help__debug__upload-stats_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli help debug upload-stats commands' commands "$@"
}
...
(( $+functions[_warp-cli__help__environment_commands] )) ||
_warp-cli__help__environment_commands() {
    local commands; commands=(
'set:Set the client'\''s compliance environment' \
'reset:Reset the client'\''s compliance environment override' \
    )
    _describe -t commands 'warp-cli help environment commands' commands "$@"
}
(( $+functions[_warp-cli__help__environment__reset_commands] )) ||
_warp-cli__help__environment__reset_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli help environment reset commands' commands "$@"
}
(( $+functions[_warp-cli__help__environment__set_commands] )) ||
_warp-cli__help__environment__set_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli help environment set commands' commands "$@"
}
